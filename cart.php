...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="sub-total"> Tổng cộng : <span>VND<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
      </form>
      <?php
   ...
   <div class="cart-total">
      <p>Tổng tiền giỏ hàng : <span><?= $grand_total; ?> VND</span></p>
   ...
   <div class="more-btn">
      ...
      <a href="menu.php" class="btn">Tiếp tục đặt đồ</a>
   </div>
